...
U_hf_test = U_hf_tensor[test_indices]

np.savez(
    f"./test_dataset_ns{n_s}_epsPOD{eps_POD}_testsize{test_size}.npz",
    X_test=X_test.numpy(),
    Y_test=Y_test.numpy(),
    U_hf_test=U_hf_test.numpy()
)
...
# Test Loss: 0.00000046
# Relative l2 Error: 0.00106574
